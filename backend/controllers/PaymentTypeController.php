...
class PaymentTypeController extends Controller {
    ...
    /**
     * Creates a new PaymentTypeWrapper model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate() {
        $model = new PaymentTypeWrapper();
    ...
    /**
     * Updates an existing PaymentTypeWrapper model.
    ...
    /**
     * Deletes an existing PaymentTypeWrapper model.
    ...
    protected function findModel($id) {
        if (($model = PaymentTypeWrapper::find()->where(['id' => $id])->multilingual()->one()) !== null) {
            return $model;
        } else {
