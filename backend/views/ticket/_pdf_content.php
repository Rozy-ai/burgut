...
<div style="width: 100%; height: 1500px; background: #fff; font-family: Arial, sans-serif">
    ...
    <div
            ...
            <div style="float: left;width: 60%; border: 0px solid #f45; display: inline-block">
                ...
                echo \yii\widgets\DetailView::widget([
                    ...
                    'template' => '<div style="display: block; width: 100%; margin-bottom: 8px">
                                    <div style="font-size:13px; width: 120px; float: left; padding-right: 20px; color: #888">{label}:</div>
                                    <div style="font-size:15px; color:#000; font-weight: bold; font-stretch: semi-expanded; min-width: 80%; float: left; font-family: Verdana, Arial, sans-serif">{value}</div>
                                </div>',
                    'options' => [
                        'tag' => 'div',
                    ]
        ...
        <?php if ($model->status == \common\models\wrappers\TicketWrapper::STATUS_SUCCESS && isset($paymentModel) && isset($paymentModel->status_response_json)) { ?>
            ...
            if (isset($payment_status_response)) { ?>
                ...
                <div style="width: 100%;border-bottom: 1px solid #dddddd; margin-bottom: 15px;">
        ...
        <div style="width: 100%; padding: 15px; border: 1px solid #555555; margin-bottom: 25px;">
