...
$form->field($model, 'icon')->hiddenInput()->label('') ?>
    </div>
    <div>
    </div>
      </div>
...
//  });
     ...
     $(".col-sm-6").on("click", function(){
        ...
        $("#itemwrapper-icon").val(JSON.stringify(value));
       $(".selected_icon").html ("<i class=\'"+value.class+" \' style=\'font-size: 50px;\'></i>");
