...
<section class="breadcrumb_area_two parallaxie" style="    background: #F1F5FB;">
...
<section class="contact" style="margin-bottom: 0">
    <div class="container bg-white">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 contact_data">
                <div class="row">
                    <div class="col-6 d-flex align-self-start contact_icons">
